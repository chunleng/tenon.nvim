...
1. Check each step's artifact matches next step's input
...
1. Purpose → Process → Artifact alignment
...
- Step artifacts match next step inputs
- goto conditions mutually exclusive
- Each step has clear Purpose, Process, Artifact
