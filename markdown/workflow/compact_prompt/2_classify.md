...
3. Respect Tenon prompt structures when classifying. Directive conditions, workflow step artifacts, and constraint clauses are load-bearing by nature — do not classify structural elements as redundant or shorten
