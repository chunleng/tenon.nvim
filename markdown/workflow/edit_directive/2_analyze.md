...
3. Determine the action based on the comparison:
   - **No directive needed**: the problem is already fully covered, is a one-off, or is not a directive issue (e.g. a workflow issue, a tool configuration issue)
...
4. If the action is "no directive needed":
   ...
   - If the user confirms, stop — the workflow ends here
...
8. If the user confirms, proceed to the next step. If the user disagrees or refines, loop back to process step 2 or 3 as needed
