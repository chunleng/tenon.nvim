...
5. Summarize the understood requirements as an array, output it, and confirm with the user before proceeding. If requirements changed, loop back to process step 4 (interview) and re-confirm
