...
```yaml
goal: |
  Free-text description of what to compact. If file-based, include file paths and sections for later moves to locate the target text. If inline text, include the text itself.
```
